...
bq_seropos_symp_contact_1d5 <- run_analysis_bq_sym_contact(bq_model=bq_model_symp,
...
bq_seropos_symp_contact_first6 <- run_analysis_bq_sym_contact(bq_model=bq_model_symp,
                                                                    dat_expand=sero_dat_expand %>% 
...
bq_seropos_symp_contact_last6 <- run_analysis_bq_sym_contact(bq_model=bq_model_symp,
                                                                    dat_expand=sero_dat_expand %>% 
                                                                      filter(as.character(week)>6),
                                                                    coef_eqn="sex + age_cat",
                                                                    chains=n_chains,
