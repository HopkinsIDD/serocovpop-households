...
# format the cleaned input data ready for stan model
sero_dat <- dat_full %>% 
...
# expand the dataset incorporating all possible sequences of viral intro and subsequent infection events within hh
source(here("source/generation_template_updated.R"))
